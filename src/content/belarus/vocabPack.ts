...
export const level13VocabPack: VocabPack = {
  levelId: "spring-city",
  words: [
    {
      id: "buket",
      script: "БУКЕТ",
      translation: "bouquet",
      matchesItemId: "buket_flowers",
      pronunciation: "boo-KYET",
      ipa: "/bʊˈkʲet/",
      hint: "Wrapped in paper. Smells nice. The thing you bring to apologize.",
    },
    {
      id: "tsvetochnaya",
      script: "ЦВЕТОЧНАЯ",
      ...
      matchesItemId: null,
      category: "location",
      pronunciation: "tsveh-TOHCH-nah-yah",
      ipa: "/tsvʲɪˈtotɕnəjə/",
      hint: "The place that sells the colorful things. Not a paint store.",
    },
    {
      id: "gazeta",
      script: "ГАЗЕТА",
      translation: "newspaper",
      matchesItemId: "gazeta_paper",
      pronunciation: "gah-ZYEH-tah",
      ipa: "/ɡɐˈzʲetə/",
      hint: "Black and white and read all over. Yesterday's news for free.",
    },
    {
      id: "kiosk",
      script: "КИОСК",
      ...
      matchesItemId: null,
      category: "location",
      pronunciation: "kee-OHSK",
      ipa: "/kʲɪˈosk/",
      hint: "Small. Metal. On the corner. Papers and cigarettes. Man inside doesn't smile.",
    },
    {
      id: "bulka",
      script: "БУЛКА",
      translation: "bread bun / roll",
      matchesItemId: "bulka_bun",
      pronunciation: "BOOL-kah",
      ipa: "/ˈbulkə/",
      hint: "Round. Warm. Golden crust. The smell that makes you follow it.",
    },
    {
      id: "khlebozavod",
      script: "ХЛЕБОЗАВОД",
      translation: "bread factory (outlet)",
      matchesItemId: null,
      category: "location",
      pronunciation: "khlyeh-bah-zah-VOHT",
      ipa: "/xlʲɪbɐzɐˈvot/",
      hint: "Where the bread comes from. The source. The origin of warm.",
    },
    {
      id: "vesna",
      script: "ВЕСНА",
      ...
      matchesItemId: null,
      category: "location",
      pronunciation: "vyehs-NAH",
      ipa: "/vʲɪsˈna/",
      hint: "Snow melts. Flowers bloom. Puddles everywhere. It smells like mud and hope.",
    },
  ],
};
